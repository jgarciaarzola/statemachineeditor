...
public class test {
  ...
  // --------------------------------------------------------------------------------
   	...
   	protected StateType state = StateType.E1;
  ...
  protected void evt_evento0(StateType currState, StateType nextState, //
      EventType event, Map<String, Object> ctx, Map<String, Object> par) {
    // Empty
  }
  ...
  protected void E0_evento0_E1(Map<String, Object> ctx, Map<String, Object> par) {
    // Empty
  }

  // --------------------------------------------------------------------------------

  protected void E0_evento1_E2(Map<String, Object> ctx, Map<String, Object> par) {
    // Empty
  }

  // --------------------------------------------------------------------------------

  protected void E1_evento1_E3(Map<String, Object> ctx, Map<String, Object> par) {
    // Empty
  }

  // --------------------------------------------------------------------------------

  protected void E1_evento0_E2(Map<String, Object> ctx, Map<String, Object> par) {
    // Empty
  }

  // --------------------------------------------------------------------------------

  protected void E2_evento3_E3(Map<String, Object> ctx, Map<String, Object> par) {
    // Empty
  }
  ...
  private void evtStateChange(StateType currState, StateType nextState, //
    ...
    switch (event) {
      case evento0 :
        evt_evento0(currState, nextState, event, ctx, par);
        break;
      case evento1 :
